...
public class AgendamentoConcluidoEvent implements DomainEvent {
    ...
    public AgendamentoConcluidoEvent(Long agendamentoId, Long profissionalId) {
    ...
    public String toString() {
        return "AgendamentoConcluidoEvent{" +
                "eventId=" + eventId +
